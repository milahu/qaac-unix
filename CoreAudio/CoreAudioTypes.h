...
enum
{
    kAudioFormatLinearPCM               = *(int32_t*)"lpcm",
    kAudioFormatAC3                     = *(int32_t*)"ac-3",
    kAudioFormat60958AC3                = *(int32_t*)"cac3",
    kAudioFormatAppleIMA4               = *(int32_t*)"ima4",
    kAudioFormatMPEG4AAC                = *(int32_t*)"aac ",
    kAudioFormatMPEG4CELP               = *(int32_t*)"celp",
    kAudioFormatMPEG4HVXC               = *(int32_t*)"hvxc",
    kAudioFormatMPEG4TwinVQ             = *(int32_t*)"twvq",
    kAudioFormatMACE3                   = *(int32_t*)"MAC3",
    kAudioFormatMACE6                   = *(int32_t*)"MAC6",
    kAudioFormatULaw                    = *(int32_t*)"ulaw",
    kAudioFormatALaw                    = *(int32_t*)"alaw",
    kAudioFormatQDesign                 = *(int32_t*)"QDMC",
    kAudioFormatQDesign2                = *(int32_t*)"QDM2",
    kAudioFormatQUALCOMM                = *(int32_t*)"Qclp",
    kAudioFormatMPEGLayer1              = *(int32_t*)".mp1",
    kAudioFormatMPEGLayer2              = *(int32_t*)".mp2",
    kAudioFormatMPEGLayer3              = *(int32_t*)".mp3",
    kAudioFormatTimeCode                = *(int32_t*)"time",
    kAudioFormatMIDIStream              = *(int32_t*)"midi",
    kAudioFormatParameterValueStream    = *(int32_t*)"apvs",
    kAudioFormatAppleLossless           = *(int32_t*)"alac",
    kAudioFormatMPEG4AAC_HE             = *(int32_t*)"aach",
    kAudioFormatMPEG4AAC_LD             = *(int32_t*)"aacl",
    kAudioFormatMPEG4AAC_HE_V2          = *(int32_t*)"aacp",
    kAudioFormatMPEG4AAC_Spatial        = *(int32_t*)"aacs",
    kAudioFormatAMR                     = *(int32_t*)"samr"
};
#endif
